...
function ChipsComponent(props: IChipProps) {
    ...
    return (
        <button
            ...
            className={`inline-flex items-center px-3 py-2 text font-bold rounded-full cursor-pointer focus:outline-none focus:shadow-outline ${contextualClass} gap-2 w-max`}
        >
